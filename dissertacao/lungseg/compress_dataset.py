...
def compress_dataset(src_dir, mask_dir, dst_dir, ext, joint, reverse = False, desc = None, remove_no_lesion = False):
    ...
    np.savez_compressed(f"{output_path}/{joint}_images_exp2_lesion", list_images)
    np.savez_compressed(f"{output_path}/{joint}_masks_exp2_lesion", list_masks)
...
def main():
    ...
    main_dir_image = f'/home/anatielsantos/mestrado/datasets/dissertacao/final_tests_dis/teste2_dataset2/Test'
    main_dir_mask = f'/home/anatielsantos/mestrado/datasets/dissertacao/final_tests_dis/teste2_dataset2/Test_mask'
    ...
    dst_dir = '/home/anatielsantos/mestrado/datasets/dissertacao/final_tests_dis/teste2_dataset2'
