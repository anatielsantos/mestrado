...
def execExecPredictByUnet(src_dir, mask_dir, dst_dir, ext, search_pattern, model, reverse = False, desc = None, parallel = True):
    ...
    for input_path in input_pathAll:
        ...
        output_path = dst_dir + '/' + exam_id + '_pred_EXP4_K' + K + ext
...
def main():
    ...
    model_path = f'/data/flavio/anatiel/models/models_ds2/unet_ds2_150epc_best_k{K}.h5'
    ...
    # model_path = '/home/anatielsantos/Downloads/models_dissertacao/models_ds2/unet_ds2_150epc_best.h5'
