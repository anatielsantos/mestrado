...
def train():
    ...
    model_checkpoint = ModelCheckpoint('/home/anatiel/dados/anatiel/dataset1/unet_ds1_150epc_best_k2.h5', monitor='val_loss', save_best_only=True, mode="min")
    ...
    model.save('/home/anatiel/dados/anatiel/dataset1/unet_ds1_150epc_last_k2.h5')

    # convert the history.history dict to a pandas DataFrame:     
    hist_df = pd.DataFrame(history.history)

    # save to json:  
    hist_json_file = '/home/anatiel/dados/anatiel/dataset1/unet_ds1_150epc_k2.json'
    ...
    # save plot to file
    plt.savefig('/home/anatiel/dados/anatiel/dataset1/unet_ds1_150epc_k2.png')
    # plt.show()
