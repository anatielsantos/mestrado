...
from data_covid_ds_mixed import load_train_data, dice_coef, dice_coef_loss, dice_bce_loss

BATCH_SIZE = 1
EPOCHS = 150
K = "1"  # Definir o fold
GPU = "1"  # Definir GPU
DS = "_mixed"  # Definir dataset
...
def train():
    ...
    model_checkpoint = ModelCheckpoint(f'/data/flavio/anatiel/models/models_ds{DS}/unet_ds{DS}_k{K}_150epc_best.h5', monitor='val_loss', save_best_only=True, mode="min")
    ...
    model.save(f'/data/flavio/anatiel/models/models_ds{DS}/unet_ds{DS}_k{K}_150epc_last.h5')

    # convert the history.history dict to a pandas DataFrame:     
    hist_df = pd.DataFrame(history.history)

    # save to json:  
    hist_json_file = f'/data/flavio/anatiel/models/models_ds{DS}/unet_ds{DS}_k{K}_150epc.json'
    ...
    # save plot to file
    plt.savefig(f'/data/flavio/anatiel/models/models_ds{DS}/unet_ds{DS}_k{K}_150epc.png')
    # plt.show()
