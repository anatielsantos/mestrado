...
def load_train_data():
    # remote
    imgs_train_npz = np.load('/home/anatiel/dados/anatiel/dataset1/images_fold_1.npz', allow_pickle=True)
    masks_train_npz = np.load('/home/anatiel/dados/anatiel/dataset1/masks_fold_1.npz', allow_pickle=True)
