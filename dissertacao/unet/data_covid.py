...
def load_train_data():
    # remote
    imgs_train_npz = np.load('/data/flavio/anatiel/datasets/dissertacao/final_tests/kfold/dataset1/images_fold_9.npz', allow_pickle=True)
    masks_train_npz = np.load('/data/flavio/anatiel/datasets/dissertacao/final_tests/kfold/dataset1/masks_fold_9.npz', allow_pickle=True)
