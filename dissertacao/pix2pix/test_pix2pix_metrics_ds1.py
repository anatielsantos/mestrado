...
def execExecPredictByUnet(src_dir, mask_dir, dst_dir, ext, search_pattern, model, reverse = False, desc = None, parallel = True):
    ...
    for input_path in input_pathAll:
        ...
        output_path = dst_dir + '/' + exam_id + '_pred_exp4_gan' + ext
...
def main():
    ...
    model_path = f'/data/flavio/anatiel/models/models_ds2/gan_ds2_150epc_best.hdf5'
    ...
    # model_path = '/home/anatielsantos/Downloads/models_dissertacao/models_ds2/gan_ds2_150epc_best.hdf5'
