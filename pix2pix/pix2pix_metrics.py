...
def main():
    ...
    # local
    main_dir = f'/home/anatielsantos/mestrado/datasets/dissertacao/{dataset}/image/ZeroPedding/imagePositive/Equal32Bits/GANLungsegExp4PredsLast/VoiPulmoesMascara'
    ...
    execExecMetricsByUnet(src_dir, mask_dir, dst_dir, ext, search_pattern, reverse = False, desc = 'Metrics (Pix2pix)', parallel=False)
