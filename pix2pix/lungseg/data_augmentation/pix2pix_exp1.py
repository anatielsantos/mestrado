...
def train(path_weights, src_images_train, tar_images_train):    
    ...
    # train model
    checkpoint = ModelCheckpoint(path_weights+'gan_lungseg_exp1_100epc_augment_best.hdf5', monitor='dice', verbose=1, save_best_only=True,save_weights_only=True, mode='max')
    ...
    hist_json_file = path_json+'gan_lungseg_exp1_100epc_augment_history.json' 
    ...
    # save plot to file
    plt.savefig(path_plot+'gan_lungseg_exp1_100epc_augment_plot.png')
    # plt.show()
