...
def train(path_weights, src_images_train, tar_images_train):    
    ...
    # train model
    checkpoint = ModelCheckpoint(path_weights+'gan_lungseg_exp4_100epc_best.hdf5', monitor='dice', verbose=1, save_best_only=True,save_weights_only=True, mode='max')
    ...
    model.save(path_weights+'gan_lungseg_exp4_100epc_best.hdf5')
    ...
    hist_json_file = path_json+'gan_lungseg_exp4_100epc_history.json' 
    ...
    # save plot to file
    plt.savefig(path_plot+'gan_lungseg_exp4_100epc_plot.png')
    # plt.show()

if __name__=="__main__":
    # dataset path remote
    path_src_train = '/data/flavio/anatiel/datasets/dissertacao/train_images_ds1_equalize_hist.npz'
    path_mask_train = '/data/flavio/anatiel/datasets/dissertacao/train_masks_ds1_equalize_hist.npz'
