...
def train(src_images_train, tar_images_train):    
    ...
    # train model
    checkpoint = ModelCheckpoint(path_weights+'gan_500epc_best_2.hdf5', monitor='dice', verbose=1, save_best_only=True,save_weights_only=True, mode='max')
    ...
    model.save(path_weights+'gan_500epc_last_2.hdf5')
    ...
    hist_json_file = path_json+'gan_history_500epc_2.json' 
    ...
    # save plot to file
    plt.savefig(path_plot+'gan_plot_500epc_2.png')
    # plt.show()
