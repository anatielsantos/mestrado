...
path_mask1 = glob.glob("/home/anatielsantos/Documents/Mestrado/2020.1/Databases COVID-19/dataset1 - COVID-19 CT Lung and Infection Segmentation Dataset/Lung_and_Infection_Mask/*.nii")
path_mask_lung1 = glob.glob("/home/anatielsantos/Documents/Mestrado/2020.1/Databases COVID-19/dataset1 - COVID-19 CT Lung and Infection Segmentation Dataset/Lung_Mask/*.nii")
...
# CT Lung Dataset
path_image1 = glob.glob("/home/anatielsantos/Documents/Mestrado/2020.1/Databases COVID-19/dataset1 - COVID-19 CT Lung and Infection Segmentation Dataset/COVID-19-CT-Seg_20cases/*.nii")
...
def get_roi_lung(path_mask, path_image):
    ...
    for v in range(volume):
        ...
        for i in np.unique(sitk.GetArrayFromImage(mask_nova))[1:]:
            ...
            sitk.WriteImage(roi,f"/home/anatielsantos/mestrado/datasets/dissertacao/bbox/lung_vol{v}.nii")

#get_roi_lung_infection(path_mask2, path_image2)
get_roi_lung(path_mask_lung1, path_image1)