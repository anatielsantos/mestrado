...
def train():
    ...
    model_checkpoint = ModelCheckpoint('/data/flavio/anatiel/models/dissertacao/unet_exp2_500epc_best.h5', monitor='val_loss', save_best_only=True)
    ...
    model.save('/data/flavio/anatiel/models/dissertacao/unet_exp2_500epc_last.h5')
        
    # convert the history.history dict to a pandas DataFrame:     
    hist_df = pd.DataFrame(history.history) 
    
    # save to json:  
    hist_json_file = '/data/flavio/anatiel/models/dissertacao/unet_exp2_history_500epc.json'
    ...
    # save plot to file
    plt.savefig('/data/flavio/anatiel/models/dissertacao/unet_exp2_plot_500epc.png')
    # plt.show()
