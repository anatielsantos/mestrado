...
def train():
    ...
    model.save('/data/flavio/anatiel/models/dissertacao/unet_exp3_500epc_last_int16.h5')
        
    # convert the history.history dict to a pandas DataFrame:     
    hist_df = pd.DataFrame(history.history) 
    
    # save to json:  
    hist_json_file = '/data/flavio/anatiel/models/dissertacao/unet_exp3_history_500epc_int16.json'
    ...
    # save plot to file
    plt.savefig('/data/flavio/anatiel/models/dissertacao/unet_exp3_plot_500epc_int16.png')
    # plt.show()
