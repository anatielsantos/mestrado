...
def load_train_data():
    imgs_train_npz = np.load('/home/anatiel/datasets/dissertacao/train_images.npz', allow_pickle=True)
    masks_train_npz = np.load('/home/anatiel/datasets/dissertacao/train_masks.npz', allow_pickle=True)
