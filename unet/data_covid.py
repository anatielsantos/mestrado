...
def load_train_data():
    imgs_train_npz = np.load('/home/flavio/anatiel/mestrado/dissertacao/dataset/A/train_image.npz')
    masks_train_npz = np.load('/home/flavio/anatiel/mestrado/dissertacao/dataset/B_lung/train_mask.npz')
