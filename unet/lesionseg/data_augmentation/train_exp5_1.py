...
def load_train_data():
    # remote
    imgs_train_npz = np.load('/data/flavio/anatiel/datasets/dissertacao/final_tests/train_images_exp5.npz', allow_pickle=True)
    masks_train_npz = np.load('/data/flavio/anatiel/datasets/dissertacao/final_tests/train_masks_exp5.npz', allow_pickle=True)
