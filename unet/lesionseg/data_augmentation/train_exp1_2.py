...
def train():
    ...
    model_checkpoint = ModelCheckpoint('/data/flavio/anatiel/models/dissertacao/final_tests/unet_exp1_2_best.h5', monitor='val_loss', save_best_only=True, mode="min")
    ...
    model.save('/data/flavio/anatiel/models/dissertacao/final_tests/unet_exp1_2_last.h5')
        
    # convert the history.history dict to a pandas DataFrame:     
    hist_df = pd.DataFrame(history.history)
    
    # save to json:  
    hist_json_file = '/data/flavio/anatiel/models/dissertacao/final_tests/unet_exp1_2.json'
    ...
    # save plot to file
    plt.savefig('/data/flavio/anatiel/models/dissertacao/final_tests/unet_exp1_2.png')
    # plt.show()
