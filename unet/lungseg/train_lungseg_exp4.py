...
def train():
    ...
    model_checkpoint = ModelCheckpoint('/data/flavio/anatiel/datasets/dissertacao/unet_exp4_100epc_lungseg_best.h5', monitor='val_loss', save_best_only=True, mode="min")
    ...
    model.save('/data/flavio/anatiel/datasets/dissertacao/unet_exp4_100epc_lungseg_last.h5')
        
    # convert the history.history dict to a pandas DataFrame:     
    hist_df = pd.DataFrame(history.history) 
    
    # save to json:  
    hist_json_file = '/data/flavio/anatiel/datasets/dissertacao/unet_exp4_100epc_lungseg_history.json'
    ...
    # save plot to file
    plt.savefig('/data/flavio/anatiel/datasets/dissertacao/unet_exp4_100epc_lungseg_plot.png')
    # plt.show()
